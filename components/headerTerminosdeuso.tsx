...
import { useHeaderTermsTranslation } from "../hooks/useLanguage";
import { languageNames, Language } from "../lib/i18n";

export function Headertermsuse() {
  const { t, isClient, language, changeLanguage } = useHeaderTermsTranslation();
